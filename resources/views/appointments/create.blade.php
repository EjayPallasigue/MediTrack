<x-layouts.admin title="Schedule Appointment">
    <header class="header">
        <h1 class="header-title">Schedule New Appointment</h1>
            ...
            <form action="{{ route('appointments.store') }}" method="POST">
                ...
                <div class="mt-6">
                    ...
                    <textarea name="diagnosis" id="diagnosis" rows="3"
                              class="form-textarea">{{ old('diagnosis') }}</textarea>
                    @error('diagnosis')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mt-6">
                    ...
                    <textarea name="treatment" id="treatment" rows="3"
                              class="form-textarea">{{ old('treatment') }}</textarea>
                    @error('treatment')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
